...
private:
    ...
    std::string current_Radio_url_;
    std::string current_song_name_;
    bool song_name_displayed_;
    //bool is_radio_mode_ = false;
    // 歌词相关
    ...
    // 私有方法
    void DownloadAudioStream(const std::string& Radio_url);
...
public:
    ...
    // 新增方法
    virtual bool StartStreaming(const std::string& Radio_url) override;
